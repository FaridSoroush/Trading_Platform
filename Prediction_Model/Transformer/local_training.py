...
for epoch in range(num_epochs):
    ...
    # Validate every 5 epochs and save the best model
    if (epoch + 1) % 5 == 0:
        model.eval()
        val_loss = 0
        val_accuracy = 0
        ...
        if val_loss < best_val_loss:
            ...
            output_filename = f'new_model_parameters_{n_steps}_{num_layers}_{num_heads}_{num_epochs}_{batch_size}_{learning_rate}.pth'
